...
import com.example.oyd.textcirle.adapter.GridImageAdapter;
    ...
    private void loadDate() {
        ...
        mLyAiTe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(MainActivity.this, AiTeActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (bundle.getString("ai_te") != null)
                mEtContent.setText(mEtContent.getText() + "@" + bundle.getString("ai_te"));

            if (bundle.getString("topic") != null)
                mEtContent.setText(mEtContent.getText() + "#" + bundle.getString("topic")+"#");

            if (bundle.getString("article") != null)
                mEtContent.setText(mEtContent.getText() + "-" + bundle.getString("article")+"-");

            //每次添加内容后光标到末尾处
            Editable etext = mEtContent.getText();
